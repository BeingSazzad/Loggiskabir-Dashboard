        ...
        <div className="flex-1 space-y-6">
          {activeTab === 'account' && (
            <div className="space-y-6 animate-in slide-in-from-right-4 duration-300">
              <Card className="p-8 space-y-8 border-line-2">
                <section>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <input className="input-base w-full pl-12 h-12" defaultValue={role === 'admin' ? 'Admin User' : 'Dispatcher User'} />
                      </div>
                    </div>
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <input className="input-base w-full pl-12 h-12" defaultValue={role === 'admin' ? 'admin@logiss.com' : 'dispatcher@logiss.com'} />
                      </div>
                    </div>
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <input className="input-base w-full pl-12 h-12" defaultValue="(804) 555-0100" />
                      </div>
                    </div>
                    <div className="space-y-2">
                      <label className="text-xs font-bold text-ink-3 ml-1">Reporting Region</label>
                      <div className="relative">
                        <MapPin size={16} className="absolute left-4 top-1/2 -translate-y-1/2 text-ink-4" />
                        <input className="input-base w-full pl-12 h-12" defaultValue="Richmond, VA" />
                      </div>
                    </div>
                  </div>
                </section>
                ...
                <section className="pt-8 border-t border-line-2">
                  ...
                  <div className="flex items-center justify-between p-4 bg-bg rounded-2xl border border-line-2">
          ...
          {activeTab === 'security' && (
            <div className="space-y-6 animate-in slide-in-from-right-4 duration-300">
              <Card className="p-8 border-line-2">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-6 bg-white rounded-2xl border-2 border-line-2 hover:border-primary/20 transition-all group">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 bg-accent-light rounded-2xl flex items-center justify-center text-accent shadow-sm border border-accent/10">
                        <Key size={24} />
                      </div>
                      <div>
                    ...
                    <Button variant="primary-light" size="sm">Update</Button>
                  </div>

                  <div className="flex items-center justify-between p-6 bg-white rounded-2xl border-2 border-line-2 hover:border-primary/20 transition-all">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 bg-primary-light rounded-2xl flex items-center justify-center text-primary shadow-sm border border-primary/10">
                        <Smartphone size={24} />
                      </div>
                      <div>
